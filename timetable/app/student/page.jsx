...
export default function Home() {
    ...
    const fetchTimetable = async () => {
        ...
        console.log(record[0].timetable);
        setClassYear(record[0].timetable);
    }
      ...
      <div className="flex">
        ...
        <div className=" ml-12">
          ...
          <div className="flex gap-8 ml-12 mt-16">
            <select className="bg-white rounded-lg p-2" onChange={
                (e) => {
            ...
            <button className="bg-green-500 justify-center items-center rounded-lg p-2" onClick={fetchTimetable}>
              Show Timetable
            </button>
          </div>
          <div>
